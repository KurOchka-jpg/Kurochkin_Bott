...
bot = telebot.TeleBot('5143789186:AAFGnjw-8fuEuGpPkENgTU8fq4QHf504u0M')
...
def send_help(bot, chat_id):
    bot.send_message(chat_id, "Автор: Курочкин Константин 1-мд-8")
    markup = types.InlineKeyboardMarkup()
    btn1 = types.InlineKeyboardButton(text="Напишите мне!!", url="https://vk.com/lil4icha")
    markup.add(btn1)
